...
export default function PopupSeachUser({
  closePopup,
  setUser,
  setLoading,
}) {
  ...
  return (
    <>
      ...
      <div className="fixed z-10 bg-[#00000045] top-0 right-0 w-[100vw] h-[100vh] flex items-center justify-center px-3">
        <div className=" container bg-[#1E293B] rounded-lg p-5 h-fit" data-aos="zoom-in">

          <div className="flex justify-between items-center">
            <div className="text-[#f3aa60] text-xl font-bold">
              {mode === "search" ? "ค้นหาผู้ใช้งาน" : "เพิ่มรายละเอียดผู้เรียกเก็บเงิน"}
            </div>
...

          {
            mode === "search" && (
              <form onSubmit={onSearchUser}>
                <div className="text-white mb-3 mt-8 text-[18px]">ชื่อหรืออีเมล</div>
                <div
                ...
                <div className="mt-8 text-[#246BFD] text-center cursor-pointer underline" 
                     onClick={() => setMode("add")}
                >
